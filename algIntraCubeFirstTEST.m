function [TravelPaths, totalIntraTravelDistance, totalInterTravelDistance, totalIntraFlights, totalInterFlights] = algIntraCubeFirst(diffTable, leadCloudPoint, derivedCloudPoint, sanityChk, silent)
...
outputT= ['Success!  algIntraCubeFirst executed successfully.'];
disp(outputT);
